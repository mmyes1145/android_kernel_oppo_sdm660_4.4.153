...
#ifdef CONFIG_KSU_SUSFS_SUS_MOUNT
// Our own mnt_alloc_group_id() that assigns mnt_group_id starting from DEFAULT_SUS_MNT_GROUP_ID
					...
					int flag)
{
	 ...
	 * - For the rest of caller process that doing unshare => call alloc_vfsmnt() to assign a new sus mnt_id
	 */
